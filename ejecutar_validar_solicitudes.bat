...
rem Ejecutar el método validarSolicitudCotizante de la clase Main y guardar la salida en un archivo
java edu.Main validarSolicitudCotizante > salida.txt 2>&1
